...
const routes: Routes = [
  ...
  {
    path: 'verification',
    loadChildren: () => import('./user/verification/verification.module').then( m => m.VerificationPageModule)
  },
  {
    path: 'calendar',
  ...
  {
    path: 'qr-detail/:id',
    loadChildren: () => import('./qr-detail/qr-detail.module').then( m => m.QrDetailPageModule)
  },
  {
    path: 'favorite',
